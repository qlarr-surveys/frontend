            ...
            const editContent = `
              <div style="min-width: 200px;">
                ...
                <div style="margin: 8px 0;">
                  <div>Latitude:</div>
                  <input type="number" id="edit-lat-${markerKey}" value="${pos.lat.toFixed(6)}" step="0.000001" style="width: 100%; margin-bottom: 4px;" />
                  <div>Longitude:</div>
                  <input type="number" id="edit-lng-${markerKey}" value="${pos.lng.toFixed(6)}" step="0.000001" style="width: 100%;" />
                </div>
                <div style="margin-top: 8px;">
