...
export const OPERATORS = {
  ...
  select_not_any_in: {
    ...
    displayLabel: "answer doesn't include",
    category: 'selection',
    cardinality: 1,
    jsonLogicOp: 'not_in',
    applicableTypes: ['select', 'survey_lang'],
